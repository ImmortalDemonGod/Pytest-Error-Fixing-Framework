...
| **Change ID** | pef-p28-rewrite-codified-bug-tests-t-tests |
| **Commits** | `3f758b1`, `347613b` |
| **Head SHA** | `347613b` |
| **Base SHA** | `e711a89` |
| **Created** | 2026-07-15T17:54:39Z |
...
classification:
  ...
  classified_at: "2026-07-15T17:54:39Z"
```
...
|---|---------------|------------|---------|
| 1 | EVIDENCE_TESTS_PEF_P28_REWRITE_CODIFIED_BUG_TESTS_T.BUG_CATALOG.MD.md | `3f758b1` | A, B, E |
| 2 | EVIDENCE_TESTS_TEST_PR_MANAGER_AND_LOGGING_CONFIG_PROPAGATION_BUGS.md | `347613b` | A, B, E |
...
- `tests/pef-p28-rewrite-codified-bug-tests-t.bug-catalog.md#L1-L32`
- `tests/test_pr_manager_and_logging_config_propagation_bugs.py#L1-L54`
...
Change 'pef-p28-rewrite-codified-bug-tests-t-tests': 2 commit(s) across 2 file(s).
...
- Intent URL: https://github.com/ImmortalDemonGod/Pytest-Error-Fixing-Framework/blob/697ab7f3414459edd480bb72a342446d040b3134/audit/02-static-audit.md#L57
...
**Claim 3:** https://github.com/ImmortalDemonGod/Pytest-Error-Fixing-Framework/compare/e711a89...347613b
